    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                ...
                <div class="form-group">
                    <label class="control-label" for="EmailNameTextBox">Email:</label>
                    <asp:TextBox runat="server" TextMode="Email" CssClass="form-control" ID="EmailNameTextBox" placeholder="Email" required="true"></asp:TextBox>
                </div>
                <div class="form-group">
